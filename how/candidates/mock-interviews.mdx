...
description: "Perform mock interviews and receive AI feedback to help improve your performance. Practice makes perfect. Do them as many times as you like. No one can view your interviews only you - unless you publish them and have companies find you. It's a great way to promote yourself if you are looking for new opportunities."
---
...
<Steps>
  <Step title="Search based on Job Title or Category">
    ...
    - Search based on job title or click on a job category. It is type search, so the more you type the more teh results are filtered.
    - Use Card View of List view to display the results or select what level you want e.g. Graduate, Intermediate or Expert

      ![Mock Interviews2 Pn](/images/Mock-Interviews2.png)
    - Once you find the one you want click on Start Interview
  ...
  <Step title="Practice Mock Interviews">
    ...
    - This is the Live Interview Page. When you first come into it your computer or phone will ask if you want to grant permissions to your camer and microphone to our site. \*\*You need to allow this otherwise the interviews will not work. \*\*An audio will play if any of the above three are not granted and yu will not be able to proceed with the interview.
    ...
    - Attach a CV to the Interview. We will default in your CV - if you have multiple CV's uploaded you can decide on which one if you Primary CV in the CV Management page - click on CV in the left naviagtion panel and you can manage your CV's there.
  ...
  <Step title="Interview Questions">
    ...
    - Once you have started the interview questions the navigation panel will allow you to perform the following functions:
      ...
      - Add up to 2 minutes per question to your responses if you are running out of the default time allocated to that question. The time is highlighted in the top right hand corner of the navigation panel.
...
<Tip>
  **Just remember:**
  ...
  <Icon icon="heart-circle-bolt" color="#542694" />Palantrix supports—<u>but never replaces</u>—human decision-making in recruitment. Our platform helps companies manage applications efficiently while giving every candidate a fair opportunity to stand out in a competitive market.

  <Icon icon="bullseye-arrow" color="#542694" />Many factors influence hiring decisions, and sometimes it's simply about timing and specific team needs rather than your qualifications.
</Tip>