...
<Steps>
  <Step title="Create a Palantrix Short - 60 Second Pitch" icon="video">
    ...
    - Select 60 Second Pitch **___(in reality it will be requesting a 2-4 min introducatory video from candidates).___**
  ...
  <Step title="Candidate Submissions" icon="camera-web">
