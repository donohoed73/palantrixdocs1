...
<CardGroup cols={2}>
  <Card title="Plans" icon="rocket" href="/plans">
    View our pricing plans - no per click or per candidate charges. Just clear, simple and predictable pricing.
  </Card>
  <Card title="Compliance" icon="file-doc" href="/compliance">
    See how Palantrix adheres to the EU AI Act and understand what we do to ensure no bias is introduced into the process.
  </Card>
</CardGroup>

<Check>
  Sign Up for FREE at [app.palantrix.com](http://app.palantrix.com)

  No credit card required.
</Check>

<Tip>
  The easiest way to get started is to join our FREE Webinar after you sign up to get the full run down on what Palantrix offers, before you sign up to any paid plans.
</Tip>